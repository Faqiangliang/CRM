...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" action="${pageContext.request.contextPath }/user_login" method="post" >
		<DIV id=UpdatePanel1>
		              								...
		              								<TBODY>
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px" width=150>
										                		<INPUT id=txtName style="WIDTH: 130px" name=name></TD>
										                	<TD style="HEIGHT: 28px" width=370>
										                		<SPAN  id=RequiredFieldValidator3 style="FONT-WEIGHT: bold; VISIBILITY: visible; COLOR: red">${msg}</SPAN>
										                	</TD>
										                </TR>
										              	<TR>
										              	...
										              	<TR>
										                	<TD style="HEIGHT: 28px">验证码：</TD>
										               	 	<TD style="HEIGHT: 28px"><INPUT id=txtcode style="WIDTH: 130px" name=code></TD>
										              	...
										              	<TR>
                											<TD></TD>
                											<TD>
                												<INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick='javascript:WebForm_DoPostBackWithOptions(new WebF orm_PostBackOptions("btn", "", true, "", "", false, false))'  type=image src="${pageContext.request.contextPath}/images/login_button.gif" name=btn> 
              												</TD>
              											</TR>
              										</TBODY>
              									</TABLE>
