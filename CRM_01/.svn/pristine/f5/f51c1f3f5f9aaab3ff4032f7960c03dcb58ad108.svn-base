...
<body>
	<form id="form1" name="form1"
		action="${pageContext.request.contextPath}/saleVisitAction_save.action"method="post">
					...
					<td vAlign=top width="100%" bgcolor="#ffffff">
						...
						<table cellspacing="0" cellpadding="5" border="0">
							<tr>
								<td>客户名称：</td>
								<td>
									<select onchange="changeCustomer()" name="customer.cust_id" class="textbox"	id="customer" style="width: 180px; height: 21px;">
								...
								<td>拜访时间：</td>
								<td>
								<%-- <s:textfield class="textbox" id="timeId"style="width: 180px" name="visit_time" readonly="readonly" /> --%>
								<input type="date" class="textbox" id="timeId"style="width: 180px" name="visit_time">			  
								</td>
							...
							<tr>
								<td>被拜访人：</td>
								<td>
									<select name="linkMan.lkm_id" class="textbox"	id="linkman" style="width: 180px; height: 21px;">
										<option value="">--请选择--</option>
									</select>
								</td>
								<td>拜访地点：</td>
							...
							<tr>
								<td>下次拜访时间 ：</td>
								<td>
								    <%-- <s:textfield class="textbox" id="nextTimeId"style="width: 180px" maxLength="50" name="visit_nexttime" /> --%>
									<input type="date" class="textbox" id="timeId"style="width: 180px" name="visit_nexttime">		
								</td>
