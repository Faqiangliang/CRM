						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
									...
									<s:textfield class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" name="cust_mobile"/>
								</td>
							</TR>
							<TR>
								<td>客户资质 ：</td>
								<td>
									<INPUT type="file" class=textbox id=sChannel2 style="WIDTH: 180px ;HEIGHT: 23px "   name="upload">
								</td>
							...
							<tr>
								...
								<td><font color="red">${actionErrors[0]}</font></td>
							</tr>
						</TABLE>
					</TD>
