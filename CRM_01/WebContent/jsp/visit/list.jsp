...
<body>
	<form id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath}/saleVisitAction_findByPage.action"
		method="post">
												...
												<tr>
													...
													<td>
														...
														<%-- <s:textfield class="textbox" id="startTimeId"
															...
															readonly="readonly" />  --%>
															<input type="date" class="textbox" id="timeId"style="width: 180px" name="start_visit_time">
															
															- 
															<input type="date" class="textbox" id="timeId"style="width: 180px" name="end_visit_time">
										...
										<table id="grid"
											...
											<tbody>
												...
												<s:iterator var="visit" value="list">
													...
													<%--<tr
														style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
														<td><s:property value="#visit.customer.cust_name" /></td>
														<td><s:property value="#visit.visit_time" /></td>
														<td><s:property value="#visit.visit_interviewee" /></td>
