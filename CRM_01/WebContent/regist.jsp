							        	...
							        	<TR>
							          		...
							          		<TD>
									            <TABLE cellSpacing=0 cellPadding=2 border=0>
		              								<TBODY>
										              	<TR>
										                	<TD style="HEIGHT: 28px" width=80>賬 號：</TD>
										                	<TD style="HEIGHT: 28px" width=150>
										                		<INPUT id=txtName style="WIDTH: 130px" name=code></TD>
										              	...
										              	<TR>
										                	<TD style="HEIGHT: 28px" width=80>用 戶 名：</TD>
										                	<TD style="HEIGHT: 28px" width=150>
										              	...
										              	<TR>
										                	<TD style="HEIGHT: 28px">验证码：</TD>
										               	 	<TD style="HEIGHT: 28px"><INPUT id=txtcode style="WIDTH: 130px" name=""></TD>
										              	...
										              	<TR>
                											<TD></TD>
                											<TD>
                												<BUTTON id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"  type="submit"  n>提交註冊</BUTTON> 
              												</TD>
              											</TR>
              										</TBODY>
              									</TABLE>
