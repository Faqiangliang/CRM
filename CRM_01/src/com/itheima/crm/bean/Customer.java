...
public class Customer {
		...
		public String toString() {
			return "Customer [cust_id=" + cust_id + ", cust_name=" + cust_name + ", cust_user_id=" + cust_user_id
					+ ", cust_create_id=" + cust_create_id + ", cust_linkman=" + cust_linkman + ", cust_phone="
					+ cust_phone + ", cust_mobile=" + cust_mobile + ", cust_address=" + cust_address + ", cust_image="
					+ cust_image + ", cust_industry=" + cust_industry + ", cust_dource=" + cust_source + ", cust_level="
					+ cust_level + "]";
		}
